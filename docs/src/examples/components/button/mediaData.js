  ...
  [
    {
      ...
      tooltip: 'Orchestral music',
      url: `${videoPath}/casino.mp4`,
    },
    {
      background: `${path}/react.jpg`,
      tooltip: 'Percussion music',
      url: `${videoPath}/react.mp4`,
    },
    {
      background: `${path}/game.jpg`,
      tooltip: 'Percussion music',
      url: `${videoPath}/gaming.mp4`,
    },
  ],
  [
    {
      ...
      tooltip: 'Orchestral music',
      url: `https://player.vimeo.com/video/369521302/config?autopause=1&byline=0&collections=1&context=Vimeo%5CController%5CClipController.main&default_to_hd=1&outro=nothing&portrait=0&share=1&title=0&watch_trailer=0&s=32ec6c8ef0c6d53a1c2a44788684d7476c7eac7f_1606750930`,
    },
    {
      background: `${path}/react.jpg`,
      tooltip: 'Percussion music',
      url: `https://www.youtube.com/watch?v=nn-0rd2fDsU`,
    },
    {
