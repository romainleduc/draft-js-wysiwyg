...
export interface AtomicAudioProps extends AtomicMediaProps, React.AudioHTMLAttributes<HTMLAudioElement> {}

export interface AtomicAudioButtonProps extends Omit<AtomicButtonProps, 'mediaType' | 'atomicVideoProps'> {
