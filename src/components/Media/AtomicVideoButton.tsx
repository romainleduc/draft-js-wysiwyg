...
export interface AtomicVideoProps extends AtomicMediaProps, React.VideoHTMLAttributes<HTMLVideoElement> {}

export interface AtomicVideoButtonProps extends Omit<AtomicButtonProps, 'mediaType' | 'atomicAudioProps'> {
